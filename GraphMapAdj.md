This [GraphMapAdj](http://code.google.com/p/ugl-uminho-cpd/source/browse/trunk/Graphs/src/GraphADType/GraphMapAdj.java) implementation uses a list of neighborhoods stored for each node.
