 ...
 * @author nuno
 */
public final class PrimVisitor<N extends Node, E extends EdgeEO> implements Visitor<N, E> {
    ...
    public static void main(String[] args){
        ...
        PrimVisitor<Node<String>, EdgeEO<String, Integer>> prim_visitor =
                new PrimVisitor<Node<String>, EdgeEO<String, Integer>>(g);
